...
public class OperationInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the message value for this OperationInfo.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this OperationInfo.
     * 
     * @param message
     */
    ...
    /**
     * Gets the ok value for this OperationInfo.
     * 
     * @return ok
     */
    public boolean isOk() {
    ...
    /**
     * Sets the ok value for this OperationInfo.
     * 
     * @param ok
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.trabajos.appdist.grados.scc.uned.es/", "operationInfo"));
